...
client.on("guildMemberAdd", function(member) {
    const wc = member.guild.channels.find("name", "we")
        const embed = new Discord.RichEmbed()
        .setColor('B90C0C')
...
client.on('guildMemberRemove', member => {
    ...
    .setColor('RED')
var channel =member.guild.channels.find('name', 'welme')
if (!channel) return;
...
3ping ⇏لمعرفة سرعة أتصال البوت
3credit ⇏لمعرفت رصيدك بلبوت
3daily ⇏لتأخد رصيدك اليومي بلبوت
3trans ⇏لتعطي كريدت لشخص منشنه واكتب رقم المبلغ
3avatar ⇏لتعرض صورتك
3id ⇏لعرض معلومات الشخصية
3server ⇏لعرض معلومات السيرفر
3roles ⇏لمعرفت الرولات الموجودة بسيرفر
3kick ⇏لتطرد عضو منشنه وسبب
3ban ⇏لتبنيد عضو منشنه وسبب
3unban ⇏لتفك البند عن الشخص منشنه
3mute ⇏لتعطي ميوت كتابي منشنه والمدة
3unmute ⇏لتفك الميوت عن الشخص منشنه
3clear ⇏لمسح الشات
3bc ⇏خاصية برودكاست
3music ⇏أوامر الموسيقى كلها
 `)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
   message.channel.sendEmbed(embed)//by ,$ ReBeL ء , 🔕#4777 'CODES SERVER'
